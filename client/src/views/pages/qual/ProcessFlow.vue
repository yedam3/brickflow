<template>
    <div class="card border-0" style="height: calc(75vh - 7.5rem);">
        <h3>공통 관리</h3>
        <div class="heading-with-line mb-2">
            <h5 class="m-0 me-3">공정 흐름도 관리</h5>
        </div>
        <div class="d-flex flex-wrap justify-content-end gap-2 text-end">
        ...
        <div class="grid grid-cols-2 gap-6">
            <div>
                ...
                <ag-grid-vue class="ag-theme-alpine w-full" :columnDefs="columnDefs" :rowData="rowData"
                    :gridOptions="gridOptions1" :defaultColDef="defaultColDef" @cellClicked="prodCellClicked">
                </ag-grid-vue>
            </div>
            <div>
                <div class="heading-with-line mb-2">
                ...
                <div class="flow-container border rounded-lg p-2 bg-gray-50">
                    <VueFlow :nodes="nodes" :edges="edges" class="h-80" :fit-view="true">
                    </VueFlow>
                </div>
            </div>
        </div>
    ...
    <div class="card border-0" style="min-height: calc(40vh - 4rem);">
        ...
        <ag-grid-vue ref="secondGrid" class="ag-theme-alpine w-full" :columnDefs="columnDefs2" :rowData="rowData2"
            :gridOptions="gridOptions2" rowSelection="multiple" :defaultColDef="defaultColDef"
            @cellClicked="procCellClicked" @rowDragEnd="onRowDragEnd">
        </ag-grid-vue>
    </div>

    <ProcModal :visible="showProcModal" rowSelection="multiple" @close="showProcModal = false"
